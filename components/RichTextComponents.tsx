...
export const RichTextComponents = {
    types: {
        image: ({value}: any) => {
            return (
                <div className="relative w-[97%] h-[15rem] md:h-[30rem] m-10 mx-auto">
                    <Image src={imgUrl(value).url()} alt="blog image" className='object-contain rounded-md  md:object-cover' fill  />  
                </div> 
            )
        }
    },
